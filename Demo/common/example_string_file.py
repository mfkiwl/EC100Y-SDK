...
str = "Line1-abcdef \nLine2-abc \nLine4-abcd"
str_log.info(str.split( ))     # 以空格为分隔符，包含 \n
# ['Line1-abcdef', 'Line2-abc', 'Line4-abcd']
str_log.info(str.split(' ', 1)) # 以空格为分隔符，分隔1次
# ['Line1-abcdef', '\nLine2-abc \nLine4-abcd']
...
str_log.info(str.startswith( 'this' ))
# True
str_log.info(str.startswith( 'is', 2))
# True
str_log.info(str.startswith( 'this', 2))
# False

# endswith() 用于判断字符串是否以指定后缀结尾
str = "this is string example....wow!!!"
str_log.info(str.endswith( 'wow'))
# False
str_log.info(str.endswith( "wow!!!"))
# True
...
str_log.info(str.strip('0'))  # 去除首尾字符 0
# 3210Python0123
str2 = "   Python      "
...
str_log.info(str.replace("is", "was"))
# thwas was string example....wow!!! thwas was really string
str_log.info(str.replace("is", "was", 3))
